...
const MuhendislerdenYazilar = () => {
    ...
    return (
        <>
            <Helmet><title>Öğrencilerimizden Yazılar | Bilgisayar Mühendisliği</title></Helmet>
            {
                isLoaded ?
                    <div className='max-w-7xl mx-auto my-5'>
                        <div className='blog-h-setter relative m-1'>
                            <Link to={'/blog/' + firstPost.href}>
...
export default MuhendislerdenYazilar