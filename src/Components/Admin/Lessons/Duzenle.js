...
const Duzenle = (props) => {
    ...
    const update = async (e) => {
        e.preventDefault();
        await axios.post(window.apiBase + '/update-lesson', {
    ...
    return (
        <>
                                        ...
                                        <div className="mt-2 text-center mx-4 sm:text-left">
                                            ...
                                            <div className="mt-2 font-light">
                                                ...
                                                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    ...
                                                    max={8}
                                                    placeholder="Yarıyıl"
                                                    defaultValue={props.currentData.semester}
                                                />
                                                ...
                                                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    ...
                                                    defaultValue={props.currentData.theorical}
                                                />
                                                ...
                                                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    ...
                                                    defaultValue={props.currentData.pratical}
                                                />
                                                ...
                                                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    ...
                                                    min={0}
                                                    placeholder="Kredi"
                                                    defaultValue={props.currentData.credit}
                                                />
                                                ...
                                                <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    ...
                                                    min={0}
                                                    placeholder="AKTS"
                                                    defaultValue={props.currentData.akts}
                                                />
                                            </div>
                                        </div>
                                    </div>
            ...
            <button onClick={() => { setOpen(true); }} className='font-sans font-bold text-white bg-green-600 hover:bg-green-700 transition py-2 px-4 rounded'>Düzenle</button>
        </>
    )
}
