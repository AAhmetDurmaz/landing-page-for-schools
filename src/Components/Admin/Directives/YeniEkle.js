...
const YeniEkle = () => {
    ...
    const create = async (e) => {
        ...
        if (files !== undefined) {
            ...
            await axios.post((window.apiBase + '/add-directive'), formData,
                {
    ...
    return (
        <div>
            ...
            <button onClick={() => { setOpen(true); }} className='bg-green-600 hover:bg-green-800 text-white px-5 py-2 rounded transition font-sans font-bold'>Yeni yönetmelik/yönerge oluştur</button>
        </div>
    )
}
