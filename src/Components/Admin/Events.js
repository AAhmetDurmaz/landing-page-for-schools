...
import Duzenle from './Events/Duzenle';
import Sil from './Events/Sil';
import YeniEkle from './Events/YeniEkle';
                ...
                isLoaded ?
                    <div>
                        <div className='max-w-7xl mx-auto'>
                            ...
                            <div>
                                <p className='text-5xl uppercase font-bold font-sans text-center border-b mb-3 text-firstColor'>Etkinlikler</p>
