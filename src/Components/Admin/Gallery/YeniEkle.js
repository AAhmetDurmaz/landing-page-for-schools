...
const YeniEkle = () => {
    ...
    const create = async (e) => {
        ...
        if (imageFiles !== undefined) {
            ...
            await axios.post((window.apiBase + '/add-image'), formData,
                {
    ...
    return (
        <div>
                                ...
                                <form onSubmit={(e) => create(e)}>
                                    <div className="bg-white px-4 pt-5 pb-4">
                                        <div className="mt-2 text-center mx-4 sm:text-left">
                                            ...
                                            <label className="block text-gray-700 text-sm font-bold mt-2">Yazı girin (Resmin altında gözükecek):</label>
                                            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                name='headline'
                                                type="text"
                                                placeholder="Ana Yazı"
                                            />
                                            <label className="block text-gray-700 text-sm font-bold mt-2">Açıklama girin (Resmin altında):</label>
                                            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                name='desc'
                                                type="text"
                                                placeholder="Açıklama Yazı"
                                            />
            ...
            <button onClick={() => { setOpen(true); }} className='bg-green-600 hover:bg-green-800 text-white px-5 py-2 rounded-lg transition font-sans font-bold'>Yeni resim ekle</button>
        </div >
    )
}
