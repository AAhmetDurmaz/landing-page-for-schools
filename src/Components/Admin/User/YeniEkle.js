...
const YeniEkle = (props) => {
    ...
    const update = async (e) => {
        e.preventDefault();
        await axios.post((window.apiBase + '/add-user'),
            {
    ...
    return (
        <div>
            ...
            <button onClick={() => { setOpen(true); }} className='bg-green-600 hover:bg-green-800 text-white px-5 py-2 rounded transition font-sans font-bold'>Yeni yetkili ekle</button>
        </div>
    )
}
