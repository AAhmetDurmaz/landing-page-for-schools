...
const YeniEkle = () => {
    ...
    const create = async (e) => {
        ...
        if (imageFiles !== undefined) {
            ...
            await axios.post((window.apiBase + '/add-last-month'), formData,
                {
    ...
    return (
        <div>
            ...
            <button onClick={() => { setOpen(true); }} className='bg-green-600 hover:bg-green-800 text-white px-5 py-2 rounded-lg transition font-sans font-bold'>Yeni gönderi ekle</button>
        </div >
    )
}
